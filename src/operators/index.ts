...
export const ARCHETYPE_PROFILES: Record<OperatorArchetype, ArchetypeProfile> = {
  recon: {
    ...
    defaultTools: ['dns_lookup', 'reverse_dns', 'whois_lookup', 'subdomain_enum', 'nmap_scan', 'port_scan', 'network_trace', 'version_detect', 'robots_txt_fetch', 'cidr_expand', 'technology_detect', 'http_request', 'curl_request', 'header_analysis', 'api_endpoint_discovery', 'solana_address_validate', 'solana_rpc_health'],
    toolCategories: ['recon', 'web', 'solana'],
    capabilities: ['osint', 'dns_enum', 'subdomain_discovery', 'port_scanning', 'service_detection', 'solana_rpc_mapping'],
  ...
  scanner: {
    ...
    defaultTools: ['nuclei_scan', 'ssl_scan', 'cors_check', 'csp_analysis', 'clickjacking_test', 'cookie_analysis', 'http_methods_test', 'open_redirect_test', 'port_scan', 'version_detect', 'technology_detect', 'api_endpoint_discovery', 'header_analysis', 'http_request', 'curl_request', 'solana_address_validate', 'solana_account_lookup', 'solana_program_audit_plan'],
    toolCategories: ['vuln', 'web', 'recon', 'solana'],
    capabilities: ['vuln_scanning', 'web_scanning', 'service_enum', 'config_audit', 'solana_program_review'],
  ...
  coordinator: {
    ...
    defaultTools: ['cve_lookup', 'technology_detect', 'http_request', 'curl_request', 'header_analysis', 'nmap_scan', 'port_scan', 'dns_lookup', 'subdomain_enum', 'nuclei_scan', 'sqli_scan', 'api_endpoint_discovery', 'version_detect', 'ssl_scan', 'solana_rpc_health', 'solana_program_audit_plan', 'solana_transaction_dry_run_plan'],
    toolCategories: ['recon', 'web', 'vuln', 'solana'],
    capabilities: ['orchestration', 'task_management', 'communication', 'decision_making', 'solana_receipt_gating'],
  ...
  analyst: {
    ...
    mitreTactics: [],
    primaryPhases: [KillChainPhase.ACTIONS],
    defaultTools: ['cve_lookup', 'jwt_decode', 'hash_crack', 'base64_decode', 'url_encode', 'technology_detect', 'ssl_scan', 'header_analysis', 'cors_check', 'csp_analysis', 'cookie_analysis', 'whois_lookup', 'dns_lookup', 'http_request', 'curl_request', 'solana_address_validate', 'solana_account_lookup', 'solana_program_audit_plan', 'solana_transaction_dry_run_plan'],
    toolCategories: ['web', 'vuln', 'recon', 'util', 'solana'],
    capabilities: ['analysis', 'reporting', 'recommendations', 'risk_assessment', 'solana_onchain_risk'],
    techniques: [],
